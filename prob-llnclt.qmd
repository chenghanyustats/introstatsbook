...
```{r echo=FALSE, out.width="85%", fig.cap="https://en.wikipedia.org/wiki/Central_limit_theorem#/media/File:IllustrationCentralTheorem.png", fig.align='center'}
knitr::include_graphics("./images/img-prob/clt.png")
```

## CLT Illustration: A Right-Skewed Distribution

```{r clt_right_skewed, out.width="100%", echo=FALSE, cache=TRUE, fig.asp=0.3, fig.align='center'}
par(mfrow = c(1, 4))
