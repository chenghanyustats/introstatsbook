...
Here is the thing. Whether we call it prior information or prior belief, it means the *current state of knowledge* about something *before* more evidence, data, or observations are collected that help us better understand or have more knowledge of the thing we are interested. 

Personally, I prefer calling the *current state of knowledge* our **opinion**, or to be more humble, our **two cents**! As a Bayesian, we are people with opinions. We learn to be a better man from our living experiences; we become more knowledgeable by making our opinions closer and closer to the *truth*. And I claim (which is my opinion) that this is how we learn anything from our birth to the last day alive. A person without his own opinions is like a person with no brain. If you ask him a question, his answer will always be like "I have no idea", "I have no judgement", "we should collect evidence to answer the question", ...etc.
...
To be Bayesian is to rest all knowledge upon the language of conditional probabilities.
--------------------------------------------------------------------------------
