...
<span style="color:blue"> **Example:**🪙🪙 Toss a fair coin twice independently where $X$ is the number of heads. </span>
...
{{< include prob-binom-pois-ojs.qmd >}}
...
2. A Dunkin' Donuts in Milwaukee serves an average of 65 customers per hour during the morning rush.
    ...
    (c) Calculate the probability that this Dunkin' Donuts serves 55 customers in one hour during this time of day.
